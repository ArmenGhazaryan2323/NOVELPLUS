...
// Smooth scroll to sections when the buttons are clicked
document.getElementById('truck-button').addEventListener('click', () => {
    const truckSection = document.querySelector('.truck-section');
    truckSection.scrollIntoView({ behavior: 'smooth' });
  });
  
  document.getElementById('concrete-button').addEventListener('click', () => {
    const concreteSection = document.querySelector('.concrete-section');
    concreteSection.scrollIntoView({ behavior: 'smooth' });
  });
...
document.getElementById('truck-button_ph').addEventListener('click', () => {
    scrollToSection('.truck-section_ph');
});

document.getElementById('concrete-button_ph').addEventListener('click', () => {
    scrollToSection('.concrete-section_ph');
});
document.addEventListener("DOMContentLoaded", function () {
    ...
    sections.forEach(section => {
        section.addEventListener("click", function (event) {
            // Remove the active state from all sections first
    ...
    // If user clicks anywhere outside sections, reset all sections
